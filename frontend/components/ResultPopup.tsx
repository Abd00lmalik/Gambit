...
export type ResultKind = "won" | "lost" | "void" | "refund";
      ...
      {show && (
        ...
        >
          ...
          >
            ...
            >
              {kind === "won" ? "🏆" : kind === "lost" ? "💀" : kind === "refund" ? "↩️" : "⚖️"}
            </motion.div>
            ...
            <div className="mt-6 flex flex-col gap-2">
              {(kind === "won" || kind === "refund") && onClaim && (
                ...
                >
                  {claiming ? (kind === "refund" ? "Reclaiming..." : "Claiming...") : kind === "refund" ? "Reclaim Stake →" : "Claim Pot →"}
                </button>
              )}
              <button
                onClick={onDismiss}
