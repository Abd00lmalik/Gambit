...
Indexer https://prd.smk.somnia.host/v1/graphql: 5 live markets
  live market: 0x87bc7b699634f59ad97b59001b2902703b2f89f3 BTC expiry=1789047900 (4min away) q="BTC closes at or above its opening price"
  ...
  live market: 0x2ce4a2d9e6937a3d41f60a3a0c2042aada1e51de ETH expiry=1789047900 (4min away) q="ETH closes at or above its opening price"
  ...
  live market: 0xdb3b086f1e698d679ca466a2a42d8c22e24054e9 BTC expiry=1789047900 (4min away) q="BTC closes at or above its opening price"
    idx8=0x1523723DEb91CD87e87c484235A3beA6ebF7dB90 idx9=0x04567580a0849a8Ec6C94290e117FCb266918E3C
    market probe: {"addr":"0x1523723DEb91CD87e87c484235A3beA6ebF7dB90","hasCode":true,"isResolved":true,"isVoided":false,"payoutNumerators":["10000000","0"],"status":4}
    pool probe:   {"addr":"0x04567580a0849a8Ec6C94290e117FCb266918E3C","hasCode":true,"isResolved":"ERR: The contract function \"isResolved\" reverted.\n\nContract Call:\n  address:   0x04567580a0849a8Ec6C94290e117FCb266918E3C\n  f","isVoided":"ERR: The contract function \"isVoided\" reverted.\n\nContract Call:\n  address:   0x04567580a0849a8Ec6C94290e117FCb266918E3C\n  fun","payoutNumerators":"ERR: The contract function \"payoutNumerators\" reverted.\n\nContract Call:\n  address:   0x04567580a0849a8Ec6C94290e117FCb266918E","status":"ERR: The contract function \"status\" reverted.\n\nContract Call:\n  address:   0x04567580a0849a8Ec6C94290e117FCb266918E3C\n  funct"}
  live market: 0x7ce3994bd4d9d5250a0555035b623d3c70749b25 ETH expiry=1789047900 (4min away) q="ETH closes at or above its opening price"
    idx8=0xAD966aEB9902fB8de0723D3BD023136859cda2d2 idx9=0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1B0
    market probe: {"addr":"0xAD966aEB9902fB8de0723D3BD023136859cda2d2","hasCode":true,"isResolved":true,"isVoided":false,"payoutNumerators":["10000000","0"],"status":4}
    pool probe:   {"addr":"0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1B0","hasCode":true,"isResolved":"ERR: The contract function \"isResolved\" reverted.\n\nContract Call:\n  address:   0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1B0\n  f","isVoided":"ERR: The contract function \"isVoided\" reverted.\n\nContract Call:\n  address:   0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1B0\n  fun","payoutNumerators":"ERR: The contract function \"payoutNumerators\" reverted.\n\nContract Call:\n  address:   0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1","status":"ERR: The contract function \"status\" reverted.\n\nContract Call:\n  address:   0x04f9B81bBdfE926e2Dd8fBF1a98215488701C1B0\n  funct"}
  live market: 0xeec56fc701d668e8d05bdaf8689ab44037633405 BTC expiry=1789048800 (19min away) q="BTC closes at or above its opening price"
