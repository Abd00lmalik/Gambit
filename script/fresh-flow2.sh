...
# Step 2: B deposits via receive() - send raw ETH
echo -e "\n--- Step 2: B Deposits via receive() ---"
# Use --unlocked or raw send. The issue is cast send with "" doesn't work.
# Use a workaround: send with data=0x
